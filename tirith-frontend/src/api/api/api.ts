...
export const APIS = [AdminService, AnnouncementsService, AuthService, AwardsService, CloudService, EmojisService, EventsService, GuildsService, InventoryService, LeaguesService, LobbiesService, MembersService, Oauth2Service, OpenidService, ScenesService, SpritesService, ThemesService];
